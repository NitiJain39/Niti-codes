        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
                ...
                <button
                    ...
                    type="submit"
                    className={`w-full px-4 py-2 text-white ${loading?"bg-indigo-300":"bg-blue-600"} rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500`}>
